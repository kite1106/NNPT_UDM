      ...
      <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-8 md:p-12 flex flex-col justify-center">
        <div className="max-w-lg mx-auto">
          ...
          <p className="text-blue-100 text-lg mb-10">
            Nền tảng học tiếng Anh toàn diện với từ vựng, ngữ pháp, 
            luyện nghe, luyện nói và đánh giá trình độ
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-1">Học Từ Vựng & Ngữ Pháp</h3>
                <p className="text-blue-200">Học theo chủ đề, có hệ thống và dễ hiểu</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-blue-200">Công nghệ nhận diện giọng nói tiên tiến</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-1">Đánh Giá Trình Độ</h3>
                <p className="text-blue-200">Theo dõi tiến độ học tập của bạn</p>
              </div>
            </div>
          </div>

          <div className="mt-12 pt-8 border-t border-blue-500">
            <p className="text-blue-200">Đã có hơn 100,000+ người học thành công</p>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-1/2 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 md:p-10">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Đăng nhập để tiếp tục hành trình học tiếng Anh</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center mt-8 pt-6 border-t border-gray-200">
              ...
              <Link to="/" className="inline-flex items-center text-gray-500 hover:text-gray-700 mt-4 text-sm transition">
